...
class _ExplorePageState extends State<ExplorePage> {
  ...
  void initState() {
    super.initState();
    this._queryController = TextEditingController()..text = "";
  }
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                      "  You want to know more about your courses?....Type the  course name and see the feeds",
                      style:
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Successfully found ${_books.length} books.'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Sorry! We could not find the book.')),
      );
    }
